...
# a shell script that runs in every new terminal you open"

# $VARIABLE will render before the rest of the command is executed
echo "Logged in as $USER at $(hostname)"

# make sure system profile is looking in right place to see symlink for Sublime
...
alias gp='git fetch origin master && git merge origin/master'
